...
public class ProfileImageActivity extends AppCompatActivity {
    ...
    private final String PROFILE_URL = "https://shadowtalk-omega.vercel.app/api/upload-profile-image";
    ...
    private void updateContinueButtonState() {
        ...
        btnContinue.setEnabled(realImageBitmap != null && hiddenImageBitmap != null);
    }

    private void uploadProfileImages() {
        if (realImageBitmap == null || hiddenImageBitmap == null) {
            Toast.makeText(this, "Please select both real and hidden photos", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            ...
            json.put("uaid", uaid);
            json.put("real_image", bitmapToBase64(realImageBitmap));
            json.put("hide_image", bitmapToBase64(hiddenImageBitmap));
